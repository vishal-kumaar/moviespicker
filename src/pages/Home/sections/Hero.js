      ...
      <div className="bg-coverImage h-full w-full bg-fixed bg-no-repeat bg-cover">
        <div className="bg-black/60 h-full w-full px-32 py-40">
          ...
          <div className="bg-white flex rounded-3xl mt-12">
            <input type="text" placeholder="Search for movies..." className="bg-transparent py-2.5 px-5 placeholder:font-firasans rounded-3xl outline-none w-full" />
            <button className="rounded-3xl font-signika px-8 bg-gradient-to-r from-sky-500 to-indigo-500 text-white">Search</button>
          </div>
        </div>
      </div>
    </main>
